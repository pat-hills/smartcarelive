...
$get_all_consultation = getDrugsMonthly(TRUE);
...
$pageTitle = "<strong>" . htmlentities( " " . "Drugs Dispensed This Month " . strtoupper("")) . "</strong>";
...
<tbody>
      <tr style="background-color: #666; color: #fff;">
       <td style="text-align: left; width: 12%;"><strong>Patient ID</strong></td>
         ...
         <td style="text-align: left; width: 33%;"><strong>Drugs Dispensed</strong></td>
          <td style="text-align: left; width: 20%;"><strong>Dosages</strong></td>
...
while ($row = mysqli_fetch_array($get_all_consultation)) {
 ...
 <td style="width: 35%; text-align: left;">' . html_entity_decode(htmlentities(patient_name($row["patient_id"]),ENT_QUOTES),ENT_QUOTES) . '</td>
            <td style="width: 33%; text-align: left;">' . html_entity_decode(htmlentities(drug_name($row["drug_code"]),ENT_QUOTES),ENT_QUOTES) . '</td>
            
            <td style="text-align: left; width: 20%;">' . html_entity_decode(htmlentities(($label_dosage),ENT_QUOTES),ENT_QUOTES) . '</td>
</tr>
    </tbody>';
...
<tr>
<td style="text-align: left; width: 80%;"><strong>TOTAL LIST OF DRUGS</strong></td>  
