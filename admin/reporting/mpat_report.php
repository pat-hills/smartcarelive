...
$get_all_consultation = get_month_consultation(TRUE);
...
$pageTitle = "<strong>" . htmlentities( " " . "Patients Seen This Month " . strtoupper("")) . "</strong>";
...
<tbody>
      <tr style="background-color: #666; color: #fff;">
       <td style="text-align: left; width: 12%;"><strong>Patient ID</strong></td>
         ...
         <td style="text-align: left; width: 33%;"><strong>Seen By</strong></td>
...
while ($row = mysqli_fetch_array($get_all_consultation)) {
 ...
 <td style="width: 35%; text-align: left;">' . html_entity_decode(htmlentities(patient_name($row["patient_id"]),ENT_QUOTES),ENT_QUOTES) . '</td>
            <td style="width: 33%; text-align: left;">' . html_entity_decode(htmlentities(doctor_name($row["doctor_id"]),ENT_QUOTES),ENT_QUOTES) . '</td>
            
            <td style="text-align: left; width: 20%;">' . html_entity_decode(htmlentities(date("F jS, Y", strtotime($row['date_sent'])),ENT_QUOTES),ENT_QUOTES) . '</td>
</tr>
    </tbody>';
...
<tr>
<td style="text-align: left; width: 80%;"><strong>TOTAL PATIENTS SEEN</strong></td>  
