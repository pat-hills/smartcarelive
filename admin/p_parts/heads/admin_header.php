...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../assets/js/bootstrap.switch/bootstrap-switch.min.css" />
	...
	<!-- Datatables --> 
        ...
        <link rel="stylesheet" type="text/css" href="../assets/js/jquery.datatables/jquery.data Tables.min.css" />
	...
	<!-- Bootstrap fileinput-->
	<link rel="stylesheet" type="text/css" href="../assets/js/boostrap.fileinput/fileinput.min.css" />
