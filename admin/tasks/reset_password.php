...
<div class="container-fluid" id="pcont">
    <div class="page-head">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Admin - Reset Staff Password</li>
      </ol>
    </div>
    <div class="cl-mcont"> 
        <div class="row">
      <div class="col-md-12">
        ...
        <div class="block-flat">
          ...
          <div class="content">
             <form class="form-horizontal group-border-dashed" data-parsley-validate="" novalidate="" id="create_account"  action="tasks/create_staff_account.php" style="border-radius: 0px;" method="post">
