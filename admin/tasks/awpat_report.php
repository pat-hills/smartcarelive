      ...
      <div class="col-md-12">
        ...
        <table class="table table-bordered" id="datatable" >
                      ...
                      <th>Date</th>
									...
									<tbody>
										<?php get_week_consultation(FALSE); ?>
          ...
          <div><a class="btn btn-primary" href="../admin/reporting/awpat_report" target="_blank">Generate report
