      ...
      <div class="col-md-12">
        ...
        <table class="table table-bordered" id="datatable" >
                      ...
                      <th>Date</th>
									...
									<tbody>
										<?php get_year_consultation(FALSE); ?>
         ...
         <div><a class="btn btn-primary" href="../admin/reporting/aypat_report" target="_blank">Generate report
