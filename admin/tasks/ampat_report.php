    ...
    <div class="cl-mcont"> 
      ...
      <div class="col-md-12">
        ...
        <div class="block-flat">
          <div class="header">                          
            <h3>Patients Seen This Month</h3>
          </div>
          <div class="content">
        ...
        <table class="table table-bordered" id="datatable" >
                      ...
                      <th>Date</th>
									...
									<tbody>
										<?php get_month_consultation(FALSE); ?>
          ...
          <div><a class="btn btn-primary" href="../admin/reporting/mpat_report" target="_blank">Generate report
