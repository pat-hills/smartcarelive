                ...
                <div class="col-md-12">
                    ...
                    <div class="block-flat">
                        ...
                        <div class="content">
                            ...
                            <form autocomplete = "off" class="form-horizontal group-border-dashed" data-parsley-validate="" novalidate="" id="create_account"  action="" style="border-radius: 0px;" method="post">
...
<!-- 
                                ...
                                <div class="row">
                                    <div style="text-align: center; margin-top: 10px;"><input class="btn btn-primary" type="submit" name="add_investigation" value='Add Investigation'></div>
                                </div>
                            </form>
