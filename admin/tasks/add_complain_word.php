...
<div class="container-fluid" id="pcont">
    <div class="page-head">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Admin - Add Complains (Word)</li>
      </ol>
    </div>
    ...
    <div class="cl-mcont"> 
      ...
      <div class="col-md-12">
        ...
        <div class="block-flat">
          <div class="header">                          
            <h3>Add Complains (Word)</h3>
          </div>
          <div class="content">
             <form class="form-horizontal group-border-dashed" data-parsley-validate="" novalidate="" action="tasks/addword.php" style="border-radius: 0px;" method="post">
              ...
              <div style="text-align: center; margin-top: 10px;"><button class="btn btn-primary" name="add_word">Add Word</button></div>
            </form>
          </div>
        </div>
