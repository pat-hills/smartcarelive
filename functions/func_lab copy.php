...
function view_patient_lab_processed_today($request_code){
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        $sql = "SELECT * FROM tbl_req_investigation WHERE status = '1' AND payment_status = '1' AND request_code = '".$request_code."' AND doctor_id = '".$processed_by."' ";
        ...
        if($request_test_name == "LFT,"){
            ...
            <div class='col-sm-6 col-md-4'>
                <div class='friend-widget'>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a target='_blank' href='tasks/lft_lv_wlk?lab_code=".$row['request_code']."&patient_id=".$row['walk_code']."'>" . "<i class='fa fa-eye'></i>"  . "</a>
        ...
        ";
            ...
            <div class='col-sm-6 col-md-4'>
                <div class='friend-widget'>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <a target='_blank' href='tasks/ur_lv_wlk?lab_code=".$row['request_code']."&patient_id=".$row['walk_code']."'>" . "<i class='fa fa-eye'></i>"  . "</a>
                     <a onclick='return confirm(\"CLICK OK TO CONFIRM SELECTION OF PATIENT TO CONTINUE ...\")' 
                     href='tasks/conduct_test_walk_in.php?patient_id=".$row['walk_code']."&patient_name=".$patient_name."&test_names=".$request_test_name."&request_code=".$row['request_code']."&edit=true"."&lab_no=".$row['lab_no']." '>" ."<i class='fa fa-edit'></i>"."</a> 
        ...
        ";
            ...
            <div class='col-sm-6 col-md-4'>
                <div class='friend-widget'>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <a target='_blank' href='tasks/fbc_lv_wlk?lab_code=".$row['request_code']."&patient_id=".$row['walk_code']."'>" . "<i class='fa fa-eye'></i>" . "</a>
        ...
        if($request_test_name == "LFT,"){
            ...
            <div class='col-sm-6 col-md-4'>
                <div class='friend-widget'>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a target='_blank' href='tasks/lft_lv?lab_code=".$row['request_code']."&patient_id=".$row['patient_id']."'>" . "<i class='fa fa-eye'></i>" . "</a>
        ...
        ";
            ...
            <div class='col-sm-6 col-md-4'>
                <div class='friend-widget'>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a target='_blank' href='tasks/ur_lv?lab_code=".$row['request_code']."&patient_id=".$row['patient_id']."'>" . "<i class='fa fa-eye'></i>" . "</a>
        ...
        ";
            ...
            <div class='col-sm-6 col-md-4'>
                <div class='friend-widget'>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a target='_blank' href='tasks/fbc_lv?lab_code=".$row['request_code']."&patient_id=".$row['patient_id']."'>" . "<i class='fa fa-eye'></i>" . "</a>
        ...
        if($request_test_name == "LFT,"){
            ...
            <div class='col-sm-6 col-md-4'>
                <div class='friend-widget'>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    View Patient Results: <a target='_blank' href='tasks/lft_lv_wlk?lab_code=".$row['request_code']."&patient_id=".$row['walk_code']."'>" . $patient_name . "</a><br>
        ...
        ";
            ...
            <div class='col-sm-6 col-md-4'>
                <div class='friend-widget'>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    View Patient Results: <a target='_blank' href='tasks/ur_lv_wlk?lab_code=".$row['request_code']."&patient_id=".$row['walk_code']."'>" .$patient_name . "</a><br>
        ...
        ";
            ...
            <div class='col-sm-6 col-md-4'>
                <div class='friend-widget'>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    View Patient Results FBC: <a target='_blank' href='tasks/fbc_lv_wlk?lab_code=".$row['request_code']."&patient_id=".$row['walk_code']."'>" . $patient_name . "</a><br>
        ...
        ";
            ...
            <div class='col-sm-6 col-md-4'>
                <div class='friend-widget'>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    View Patient Results: <a target='_blank' href='tasks/p_v_r_wlk?lab_code=".$row['request_code']."&patient_id=".$row['walk_code']."'>" . $patient_name. "</a><br>
...
function insert_urine_re($request_code, $patient_id, $lab_staff_id, $appearance, $colour, $specific_gravity, $ph, $protein, $glucose,
                         ...
                         ,$bacteria,$yeast_like_cells,$s_haemoglobin,$leukocytes,$is_exist){
    global $connection;
...
function insert_fbc($request_code, $patient_id, $lab_staff_id, $WBC, $Lymphocytes_hash, $mid_hash, $gran_hash, $Lymphocytes_percent, 
                   $mid_percent,$gran_percent, $RBC,$HGB,$HCT,$MCV,$MCH,$MCHC,$RDW_CV,$RDW_SD,$PLT,$MPV,$PDW,$PCT,$neutrophils,$monocytes,$eosinophils,$basophils,$retics,$is_exist){
    global $connection;
...
function urine_re($patientID,$requestCode){
	...
	,ketones,blood,nitrite,bilirubin,urobilinogen,bacteria,s_haemoglobin,yeast_like_cells,crystals,t_vaginals,ova,epithelial_cell,pus_cell, rbcs,wbc_cast,leukocytes from  
...
function get_FBC_results($patientID,$requestCode){
	...
	$sql = "SELECT distinct WBC,Lymphocytes_hash,mid_hash,gran_hash,Lymphocytes_percent,mid_percent,gran_percent,RBC,HGB,HCT,MCV,MCH,MCHC,RDW_CV,RDW_SD,PLT,MPV,PDW,
     PCT,neutrophils,monocytes,eosinophils,basophils,retics  from fbc  WHERE patient_id='".$patientID."'AND request_code='".$requestCode."' ORDER BY id DESC LIMIT 1";
	$query_run=mysqli_query($connection,$sql);
	$answer = mysqli_num_rows($query_run);
	if($answer ===1){
	while($see=mysqli_fetch_array($query_run)){
...
function investigation_name($investigation_code){
	...
	$query_run = mysqli_query($connection,$sql) or die(mysqli_error());
    $query_run_results = $query_run->fetch_assoc();
	$investigation_name = $query_run_results['Investigations'];
...
//     }
   ...
   // else {
	...
	$sql = "SELECT id FROM tbl_walk_in_request_investigation WHERE contact = '".$phone."' 
    AND request_code = '".$request_code."' AND walk_code = '".$random_walk_in_code."' AND DATE(date_requested) = '".$date_taken."'";
