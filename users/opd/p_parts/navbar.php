    ...
    <li class="dropdown profile_menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <?php
             ...
             $total_notifications = total_notification_waiting_consulting_patients_from_cashier() + total_notification_waiting_from_Doctor_opd();
        ...
        ?>
          ...
          <li>
            ...
            <a style="float:left;" href="to_cashier_before_vitals"> <img style="height: 15px; height: 15px;"  alt="Avatar" src="../../assets/images/workflow.png" /> Click Here To Refresh Incoming Notification</a>
          </li>
