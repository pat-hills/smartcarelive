...
<script type="text/javascript">
  ...
  $('#vitals').change(function(){
    ...
    const schemeSelect = document.getElementById("patientsscheme");
    const insuranceSelect = document.getElementById("insurance_companies");
    const membershipInput = document.querySelector('input[name="MembershipID"]');
    ...
    btnSubmit.addEventListener("click", function (e) {
        ...
        const insuranceValue = insuranceSelect.value.trim();
        const membershipValue = membershipInput.value.trim();

        if (schemeValue === "Yes"||schemeValue === "Add") {
            if (!insuranceValue || !membershipValue) {
                alert("Please fill in both the insurance package and membership ID.");
        ...
        const confirmed = confirm("Are you sure you want to continue with action?");
        if (!confirmed) {
            e.preventDefault();
            return false;
        }
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const sendButton = document.querySelector("button[name='update']");
