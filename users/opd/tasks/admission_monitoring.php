            ...
            <div class="col-sm-7">
              ...
              <div class="personal">
               ...
               <p class="description">Sex: <?php echo @$_SESSION['sex']; ?></p><p>
                  ...
                  <!-- <a href="admission_chart_vitals" class="btn btn-success" >View Labs</a>  -->
            ...
            <div class="tab-container">
              ...
              //  set_tabs(@$_SESSION['ac_tab']);
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="" ><a href="#complains" data-toggle="tab">Medications Prescribed By Doctor</a></li>
              ...
              ?>
                       ...
                       <div class="tab-pane cont" id="Labs">
                       
                       <h3 class="hthin">Labs</h3> 
               ...
               <table  class="customers" >
                 ...
                 <?php
                                 ...
                                 $date = get_patient_on_admission_investigations(@$_SESSION['patient_id']);                        
              ?>
