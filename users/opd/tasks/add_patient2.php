            ...
            <div class="row">
                <div class="  col-md-12">
                    ...
                    <div class="row">
                                    ...
                                    <div role="form" class="form-horizontal group-border-dashed"> 
                                     ...
                                     <div class="schemeDiv" style="display:none">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" name="insurance_companies" id="insurance_companies">
                                                <option selected="true" disabled="disabled" value=""> SELECT  </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input autocomplete="off"   type="text" name="MembershipID"  class="form-control" placeholder="MEMBERSHIP ID" id="MembershipID" value="">
                                            </div>
                                        </div>
                                     </div>
                        ...
                        <?php } ?>
                        <div style="text-align: center; margin-top: 5px;"><button id="btnSubmit" onclick='return confirm("Are you sure you want to contitnue with action?")'  class="btn btn-primary" name="update_scheme_info">Register New Patient</button></div>
