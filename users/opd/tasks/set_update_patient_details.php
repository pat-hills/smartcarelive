...
get_pat_family_details($filtered_search);

//get_patient_info($filtered_search);

//patient_family_info($filtered_search);

patient_scheme($filtered_search);
if(empty($filtered_search )){
header("Location: ../update_patient.php?a=0");
}
 else {
   header("Location: ../update_patient.php?a=1");
