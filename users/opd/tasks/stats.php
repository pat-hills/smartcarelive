				...
				<div class="col-sm-6 col-md-12">
					...
					<div class="block-flat">
						...
						<div class="content">
							 ...
							 <?php if(IS_BOTH_OPD_RECORDS == true) { ?>
							 ...
							 <a href="add_patient">
									...
									<img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/patient.png" alt="logo"/>
										<div class=""><h3 style="text-align:center; color:#440060;"> Add Patient </h3></div>
										<h4 style="text-align:center"> Add New Patients</h4>
							 ...
							 <a href="to_cashier_before_vitals">
									<div style="padding:8px; margin:10px; width:25%; border-radius:10px;" class="butpro butstyle" data-step="2" data-intro="">
									<img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/vital_signs.png" alt="logo"/>
										<div class=""><h3 style="text-align:center; color:#440060;"> Patient Vitals </h3></div>
										<h4 style="text-align:center"> Take Vitals To Consulting Room</h4>
...
<a href="view_all_patients">
	   ...
	   <img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/patients.png" alt="logo"/>
		   <div class=""><h3 style="text-align:center; color:#440060;"> View Patients </h3></div>
		   <h4 style="text-align:center"> View All Registered Patients </h4>
	   ...
	   <?php } ?>
									...
									<img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/metrics.png" alt="logo"/>
										...
										<h4 style="text-align:center">View Metrics on Vitals</h4>
