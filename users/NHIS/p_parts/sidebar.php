<div id="cl-wrapper">
        ...
        <div class="menu-space">
          <div class="content">
			...
			<!-- <li><a href="patient_claims"><i class="fa fa-file-text-o"></i><span>Claims</span></a></li>
      <li><a href="claims_report"><i class="fa fa-bar-chart-o"></i><span>Reports</span></a></li>  -->
             
             <!-- <li><a href="#"><i class="fa fa-bar-chart-o"></i><span>Metrics</span></a></li>  -->
