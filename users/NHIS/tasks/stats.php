			...
			<div class="row dash-cols">
				<div class="col-sm-6 col-md-12">
					...
					<div class="block-flat">
						...
						<div class="content">
							 <div class="">
							 <a href="claims_tracker">
									<div style="padding:8px; margin:10px; width:25%; border-radius:10px;" class="butpro butstyle" data-step="2" data-intro="">
									<img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/claim.png" alt="logo"/>
										<div class=""><h3 style="text-align:center; color:#440060;"> Claims Tracker </h3></div>
										<h4 style="text-align:center">Track All Statuses Of Claims</h4>
									...
									<a href="claims_membership">
									<div style="padding:8px; margin:10px; width:25%; border-radius:10px;" class="butpro butstyle" data-step="2" data-intro="">

									<img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/id.png" alt="logo"/>
											
									<div class=""><h3 style="text-align:center; color:#440060;">Claims Membership</h3></div>
										<h4 style="text-align:center">Monitor All Periodic Patient Claims </h4>
                               
                                    </div>
									</a>


									<a href="claims_membership_report">
									<div style="padding:8px; margin:10px; width:25%; border-radius:10px;" class="butpro butstyle" data-step="2" data-intro="">
									<img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/metrics.png" alt="logo"/>
									
										<div class=""><h3 style="text-align:center; color:#440060;">Reports</h3></div>
										<h4 style="text-align:center">Generate Claims For Providers</h4>
                               
                                    </div>
									</a>

<!-- 
									<a href="medical_reporting">
									<div style="padding:8px; margin:10px; width:25%; border-radius:10px;" class="butpro butstyle" data-step="2" data-intro="">
									<img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/document.png" alt="logo"/>
										...
										<h4 style="text-align:center">View all reporting on consultations</h4>
