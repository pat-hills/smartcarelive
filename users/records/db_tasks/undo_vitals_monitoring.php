...
$activity = "Remove Patient Vitals From Monitoring Tray";
...
$sql="DELETE FROM tbl_patient_biovitals WHERE id='".$del_id."' AND patient_id ='".$patient_id."'";
...
$_SESSION['comp_err']="<div class='alert alert-warning alert-white rounded'>
								...
								<strong>Info!</strong> Patient Vitals Removed!
							 </div>";
