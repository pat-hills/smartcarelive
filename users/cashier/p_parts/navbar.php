...
<div id="head-nav" class="navbar navbar-default navbar-fixed-top">
    ...
    <li class="dropdown profile_menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <div class="avatar profile-image">
             ...
             $total_notifications = 0;
              ...
              $total_notifications = total_notification_waiting_consulting_patients_from_opd() + 
              total_notification_waiting_patients_lab_fromDoctor() + total_notification_waiting_patients_drug2depenseinfo();
        ...
        <li class="divider"></li>
        <b><i>Consultation Payment Patients</i></b>
        <li class="divider"></li>
        <?php 
        
        
        list_total_notification_waiting_consulting_patients_from_opd();
        ...
        ?>
          ...
          <b><i>Lab Payment Patients</i></b>
        <li class="divider"></li>
        <?php list_total_notification_waiting_patients_lab_fromDoctor();?>
         
        <!-- <li>
         </br> <a style="float:left;" href="add_payment"> <img style="height: 15px; height: 15px;"  alt="Avatar" src="../../assets/images/workflow.png" /> Click Here To Refresh Or Check Any Incoming Patient</a>
          </li> -->
          ...
          <b><i>Pharmacy Payment Patients</i></b>
          <li class="divider"></li>
          <?php list_total_notification_waiting_patients_drug2depenseinfo();?>
          <li>
          </br> <a style="float:left;" href="add_payment"> <img style="height: 15px; height: 15px;"  alt="Avatar" src="../../assets/images/workflow.png" /> Click Here To Refresh Or Check Any Incoming Patient</a>
          </li>
