					...
					<div class="block-flat">
						...
						<div class="content">
							 ...
							 <a href="add_payment">
									...
									<img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/payment-method.png" alt="logo"/>
										<div class=""><h3 style="text-align:center; color:#440060;">Payments</h3></div>
										<h4 style="text-align:center">Receive payment from patients</h4>
									...
									<a href="my_report">
									<div style="padding:8px; margin:10px; width:25%; border-radius:10px;" class="butpro butstyle" data-step="2" data-intro="">
									<img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/payment.png" alt="logo"/>
										<div class=""><h3 style="text-align:center; color:#440060;">Daily Collections</h3></div>
										<h4 style="text-align:center">View all payments today</h4>
                               
                                    </div>
									</a>
 									
									<a href="cashier_report">
									<div style="padding:8px; margin:10px; width:25%; border-radius:10px;" class="butpro butstyle" data-step="2" data-intro="">
									<img class="logo-img" style="display: block; margin-left: auto;margin-right: auto;width: 15%;" src="../../assets/images/invoice.png" alt="logo"/>
										<div class=""><h3 style="text-align:center; color:#440060;">Reports</h3></div>
										<h4 style="text-align:center">View and search through all payments</h4>
