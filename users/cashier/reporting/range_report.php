...
$start_date_cash = $_SESSION['start_date_cash']; 
 $end_date_cash  = $_SESSION['end_date_cash']; 

if(!empty($start_date_cash) && !empty($end_date_cash)){

$report_title = "Revenue Report From ".date("F jS, Y", strtotime($start_date_cash))." To ".date("F jS, Y", strtotime($end_date_cash));
}elseif(!empty($start_date_cash) && empty($end_date_cash)){
$report_title = "Revenue Report As At ".date("F jS, Y", strtotime($start_date_cash));      
}else{
$report_title = "Revenue Report As At ".date("F jS, Y", strtotime($end_date_cash));        
}
...
$topic = '<strong > <label style="color: #666">'. '<i style="">' .$report_title." generated on ". '</i>' .' ' . strtoupper(date("F j, Y")) . '</label></strong>';
...
////////////////////////////////// LISTING AND REPORTING ON DRUG CONSULTATIONS PAYMENTS///////////////////////////////////////////////////
...
$result = search_cashier_payment_range_option($staff_id,$start_date_cash,$end_date_cash);
$result_investigation = search_cashier_payment_range_option_invest($staff_id,$start_date_cash,$end_date_cash);
$result_drug_dispensed = search_cashier_payment_range_option_drg($staff_id,$start_date_cash,$end_date_cash);



$amount_total = search_cashier_payment_range_option_amount($staff_id,$start_date_cash,$end_date_cash);
$amount_total_fmt = number_format($amount_total, 2, '.', ',');



//amount_total_investigation
$amount_total_investigation = search_cashier_payment_range_option_amount_investigation($staff_id,$start_date_cash,$end_date_cash);
$amount_total_fmt_investigation = number_format($amount_total_investigation, 2, '.', ',');



//amount_total_drugs_received
$amount_total_drug = search_cashier_payment_range_option_amount_drug($staff_id,$start_date_cash,$end_date_cash);
