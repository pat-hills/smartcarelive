...
// $start_date_diagnosis_report = $_SESSION['start_date_diagnosis_report'];
// $end_date_diagnosis_report = $_SESSION['end_date_diagnosis_report'];
// $select_diagnosis_report = $_SESSION['select_diagnosis_report'];
// $start_age_report = $_SESSION['start_age_report'];
// $end_age_report = $_SESSION['end_age_report'];
// $gender_diagnosis_report = $_SESSION['gender_diagnosis_report']; 


$start_date_medical_history_report = $_SESSION['start_date_medical_history_report'];
$end_date_medical_history_report = $_SESSION['end_date_medical_history_report'];
$gender_medical_history_report = $_SESSION['gender_medical_history_report']; 
$category_medical_history_report = $_SESSION['category_medical_history_report']; 
...
$topic = '<strong > <label style="color: #666">  List Of Patients Diagnosed With '. '<i style="color:red;">' .$name_of_diagnose. '</i>' .' Generated On ' . strtoupper(date("F j, Y")) . '</label></strong>';
...
$sik_head_prduct .= '
         ...
         <td style="text-align: center;"><strong>Complains</strong></td>
...
$result  = search_medical_history_reports($staff_id,$start_date_medical_history_report,$end_date_medical_history_report,$category_medical_history_report,$gender_medical_history_report);
$i = 0;
while ($row = mysqli_fetch_array($result)) {
 ...
 $patient_phone = $row['phone'];
	$name = ucwords(strtolower($patient_name));  
        ...
        $a = complains_name_print($complain);
