...
$name_of_diagnose = diagnosis_name($select_diagnosis_report);
...
$result = search_diagnosis_reports($staff_id,$start_date_diagnosis_report,$end_date_diagnosis_report,$start_age_report,$end_age_report,$select_diagnosis_report,$gender_diagnosis_report);
$i = 0;
