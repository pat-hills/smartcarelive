    ...
    <li class="dropdown profile_menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <div class="avatar profile-image">
             ...
             <?php
             if(total_notification_waiting_patients_lab() != 0){
              echo  '<b style="background:red;padding:10px;border-radius:5px;">'.total_notification_waiting_patients_lab().'</b>';
             }else{
              echo  '<b style="">'.total_notification_waiting_patients_lab().'</b>';
             }
        ...
        list_total_notification_waiting_patients_lab();
        ...
        ?>
          ...
          <li>
            ...
            <a style="float:left;" href="view_lab_list"> <img style="height: 15px; height: 15px;"  alt="Avatar" src="../../assets/images/workflow.png" /> Click Here To Refresh Or Check Any Incoming Patient</a>
          </li>
      ...
      <li class="dropdown profile_menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <!-- <span><?php echo $staff_info['firstName']?></span> <b class="caret"></b> -->
        </a>
