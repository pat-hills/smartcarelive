...
class MYPDF extends TCPDF {
    ...
    public function Footer() {
        ...
        $this->SetFont('Helvetica', '', 9);
         ...
         $divSaparatefoot = '<div style="width:auto; background-color:#80daff; height:5px;  border-bottom:3px solid #ddd;padding-bottom:33px;">'.'</div>';
       ...
       <tbody>
         ...
         <tr>
            <td style="width: 100%; text-align: right;">' . "<strong>Biomedical Scientist</strong>" . '</td>
         </tr>
       </tbody>';
...
$pdf->SetFont('times', '', 11);
    ...
    $heading = "<h2 style='color: #00193a' >" . $hospital_name . "</h2>";
   ...
   // $pdf ->setPage($getStudentData);
    ...
    <tr style="color: #000;">
    <td style="text-align: left; width: 15%"><strong>Patient Name:</strong></td>
