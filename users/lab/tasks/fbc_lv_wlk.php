...
//$age = $view_patient_lab_processed_today['dob'];
...
$req_lab_test_names = $view_patient_lab_processed_today['requested_test_names'];
...
<td style="text-align: left;  font-weight:bold;margin:5px; border-bottom:1.5px solid #ddd;padding-bottom:3px;">' .$req_lab_test_names.'</td>
</tr>
