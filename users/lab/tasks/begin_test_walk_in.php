        ...
        <div class="cl-mcont">
            ...
            <div class="row">
                <div class="  col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="personal">
                                                ...
                                                <p class="description">Walk In Patient ID: <?php echo @$_SESSION['patient_id']; ?></p>


                                                <p class="description">Age: <?php echo @$_SESSION['patient_age']." "."year(s)" ?></p>
                    ...
                    <form role="form" class="form-horizontal group-border-dashed" action="db_tasks/add_lab_request_walk_in" method="post"> 

                        <?php
                        
                        $get_labs_inferences_by_code = get_labs_inferences_walk_in_by_code($_SESSION['request_code'], $_SESSION['edit']);
        ...
        <table>
            <tbody>
               ...
               ></td>								
                ...
                <tr>
                <td> <label>THYROID STIMULATING HORMONE (TSH):</label><input autocomplete="off"    style="width: 220px" id="T_S_H" name="T_S_H" placeholder="" class="form-control"
                                ...
                                <div class="block-flat">
                                    ...
                                    <table>
										<tbody>
											...
											<td> <label>Comment:</label>    
                                                <div>
                                                    <textarea  id="comment" name="commentw" class="form-control" height="60px"><?php echo $Widal_test['comment'] ?></textarea>
                                                </div>
                                            </td>
										</tbody>
									</table>
        ...
        <div class="block-flat">
            ...
            <table>
                <tbody>
                    ...
                    <td> <label>Comment:</label>    
                        <div>
                            <textarea  id="comment" name="comment_malaria" class="form-control" height="60px"><?php echo $get_MALARIA_test['remarks'] ?></textarea>
                        </div>
                    </td>
                </tbody>
            </table>
    ...
    <div class="block-flat">
        ...
        <table>
            <tbody>
                ...
                <td> <label>Comment:</label>    
                        <div>
                            <textarea  id="comment" name="comment_hepatitisB_profile" class="form-control" height="60px"><?php echo $hepatitis_B_profile['comments'] ?></textarea>
                        </div>
                    </td>
    ...
    <div class="block-flat">
        ...
        <table>
            <tbody>
                ...
                <td> <label>Comment:</label>    
                    <div>
                        <textarea id="comment" name="commentb" class="form-control" height="60px"><?php echo $get_hepatitis_B['remarks'] ?></textarea>
                    </div>
                </td>
            </tbody>
        </table>
...
<div class="col-sm-12 col-md-12">
    <div class="block-flat">
        ...
        <table>
            <tbody>
                <tr>
                <td> <label>PSA LEVEL:</label><input autocomplete="off" style="width: 220px" id="PROSTATE_SPECIFIC_ANTIGEN_LEVEL" name="PROSTATE_SPECIFIC_ANTIGEN_LEVEL"
...
<option value="<?php echo $HCV_test['test_status'] ?>"> <?php echo $HCV_test['test_status'] ?></option>
            ...
            <?php } ?>
                ...
                <td> <label>Comment:</label>    
                    <div>
                        <textarea id="comment" name="comment_HCV" class="form-control" height="60px"><?php echo $HCV_test['remarks'] ?></textarea>
                    </div>
                </td>
            </tbody>
        </table>
...
<option value="Positive"> Positive </option>
            ...
            <?php } ?>
                ...
                <td> <label>Comment:</label>    
                    <div>
                        <textarea id="comment" name="comment_SICKLING" class="form-control" height="60px"><?php echo $SICKLING_TEST['remarks'] ?></textarea>
                    </div>
                </td>
            </tbody>
        </table>
...
<option value="<?php echo $SYPHILLIS_TEST['test_status'] ?>"> <?php echo $SYPHILLIS_TEST['test_status'] ?></option>
            ...
            <?php } ?>
                ...
                <td> <label>Comment:</label>    
                    <div>
                        <textarea id="comment" name="comment_SYPHILLIS" class="form-control" height="60px"><?php echo $SYPHILLIS_TEST['remarks'] ?></textarea>
                    </div>
                </td>
            </tbody>
        </table>
 ...
 $GONORRHEA_TEST= GONORRHEA_TEST($_SESSION['patient_id'],$_SESSION['request_code']);
        ...
        <table>
            ...
            <?php } ?>
                ...
                <td> <label>Comment:</label>    
                    <div>
                        <textarea id="comment" name="comment_GONORRHEA" class="form-control" height="60px"><?php echo $GONORRHEA_TEST['remarks'] ?></textarea>
                    </div>
                </td>
            </tbody>
        </table>
...
<option value="AA"> AA</option>
            ...
            <?php } ?>
                ...
                <td> <label>Comment:</label>    
                    <div>
                        <textarea id="comment" name="comment_GENOTYPE" class="form-control" height="60px"><?php echo $GENOTYPE_TEST['remarks'] ?></textarea>
                    </div>
                </td>
            </tbody>
        </table>
...
<div class="col-sm-12 col-md-12">
    <div class="block-flat">
        ...
        <table>
            <tbody>
                <tr>
                    <td> <label>URIC ACID LEVEL:</label><input type="number" step="any" autocomplete="off" style="width: 220px" id="URIC_ACID_LEVEL_value" name="URIC_ACID_LEVEL_value" placeholder="" class="form-control"
                    value="<?php 
...
<option value="Positive"> Positive </option>
            ...
            <?php } ?>
                ...
                <td> <label>Comment:</label>    
                    <div>
                        <textarea id="comment" name="comment_SERUM_PREGNANCY_TEST" class="form-control" height="60px"><?php echo $get_serum_preg['remarks'] ?></textarea>
                    </div>
                </td>
            </tbody>
        </table>
                ...
                <td> <label>Comment:</label>    
                    <div>
                        <textarea id="comment" name="URINE_PREGNANCY_TESTcomment" class="form-control" height="60px">
                            <?php echo $get_urine_preg['remarks'] ?>
                        </textarea>
                    </div>
                </td>
            </tbody>
