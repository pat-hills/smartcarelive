...
<div class="container-fluid" id="pcont">
    <div class="page-head">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Laboratory test</li> <?php //echo $staff_id; //$_SESSION['uid']; //echo staff_profile_picture($staff_id);?>
      </ol>
    </div>
    <div class="cl-mcont"> 
	<div class="row">
						  ...
						  <div class="tab-pane active cont" id="test_request">
								...
								<div class="block-flat profile-info">
										...
										<div class="col-sm-4">
										   <table class="no-border no-strip skills">
											<tbody class="no-border-x no-border-y">
                                              ...
                                              <tr><td><b>Age</b></td><td><?php  if(isset($_SESSION['dob'])){ echo @get_age($_SESSION['dob']); }?></td></tr>
											</tbody>
										  </table>
										</div>
									</fieldset>	
											...
											<img src="
									            <?php 
                                                    if( isset($_SESSION['doctor_id']) ){
                                                        echo staff_profile_picture($_SESSION['doctor_id']); 
                                                    } else {
                                                         echo @no_image(); 
                                                    }
                                                ?>
										   ...
										   <table class="no-border no-strip skills">
											<tbody class="no-border-x no-border-y">
											  ...
											  <?php if(!isset($_SESSION['doctor_id'])){
											      echo "<tr><td><b>Notice: </b></td><td>Pending payment/No lab requested.</td></tr>";
											  } else { ?>   
											  <tr><td><b>Doctor's Name: </b></td><td><?php echo @$_SESSION['full_name']; ?></td></tr>
											  <tr><td><b>LAB No.#: </b></td><td><?php echo @$_SESSION['request_code']; ?></td></tr>
											  <?php $investigation_code = explode(',', @$_SESSION['requested_test'])?>
                                              <tr><td><b>Requested Test: </b></td><td><?php echo get_investigation_name($investigation_code); ?></td></tr>
                                              <tr><td><b>Remarks: </b></td><td><?php echo @$_SESSION['remarks']; ?></td></tr>
                                              <tr><td><b>Date Requested: </b></td><td>
                                                  <?php  if(isset($_SESSION['requested_date'])){ echo @date('jS F , Y', strtotime($_SESSION['requested_date'])); } ?></td>
                                              </tr>
                                    ...
                                    <fieldset>
                                        ...
                                        <legend>Submit to Doctor</legend>
...
<!-- 
                                                ...
                                                <div class="progress progress-striped active">
                                                  ...
                                                  <div id="output"></div>
                                                        ...
                                                        <?php // if (!empty( $_SESSION['PAS']) && !empty( $_SESSION['PAT_ID'] ) && $_SESSION['PAS'] == "Processed And Sent") { ?>
                                                       
                                                            <!-- <button disabled class="btn btn-primary pull-right "><? // echo  $_SESSION['PAT_ID'];  ?>, Medical Results Sent</button>
                                                     -->
                                                    <?php//} else{ ?>
	
     
                                                        <input type="hidden" id="status" name="status" value="1">
                                                        <a id="submit_results" class="btn btn-primary pull-right ">Submit All Processed Medical Results</a>
                                                     ...
                                                     <?php if (isset($_SESSION['request_code']) && !empty($_SESSION['request_code'])) { ?>
                                                        <a target="_blank" href="view_lab_report?code=<?php echo @$_SESSION['request_code']; ?>&patient_id=<?php echo @$_SESSION['patient_id'] ?>" class="btn btn-primary pull-right ">View Results</a> 
										...
										<a href="view_lab_list" class="btn btn-primary pull-right test"  name="upload">Back To Lab List</a> 
                                  ...
                                  <form id="haematology_form" action="tasks/haematology.php" method="post">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td> <label>Mid#:</label><input style="width: 180px" id="mid_hash" name="mid_hash" placeholder="" class="form-control"></td>
                                                <td> <label>Mid%:</label><input style="width: 180px" id="mid_percent"  name="mid_percent" placeholder="" class="form-control"></td>         
                                            </tr>
											<tr>
												<td> <label>Malaria Parasites:</label><input style="width: 180px" id="malaria_parasites" name="malaria_parasites" placeholder="" class="form-control"></td>       
                                    ...
                                    <div style="margin: 10px;" class="pull-right"><button onclick='return confirm(Are you sure you want to process results?)' class="btn btn-primary add_haematology" name="_haematology">Add Results</button></div>
                                    </form>
                                            ...
                                            <div class="panel-heading">
                                              <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse_gm">
                                                    <i class="fa fa-angle-right"></i> <span style="font-size: 20px;">General  Microbiology Tests</span>
                                                </a>
                                              </h4>
                                            </div>
						  ...
						  <div class="tab-pane cont" id="widal">
								...
								<fieldset>
									...
									<table>
										<tbody>
										    <tr>
                                                <td> <label>S typhi 'O':</label><input required style="width: 220px" id="s_typhi_o" name="s_typhi_o" placeholder="" class="form-control"></td>                                
                                            </tr>  
											<tr>
