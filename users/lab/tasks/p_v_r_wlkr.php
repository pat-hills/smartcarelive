                                ...
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-sm-6">
                                            ...
                                            <h6 style="font-weight:bolder;margin:5px; border-bottom:1.5px solid #ddd;padding-bottom:3px;font-size:large" class="text-dark mb-1">Name: <?php echo $full_name; ?></h6>
                                            ...
                                            <div style="font-weight:bolder;margin:5px; border-bottom:1.5px solid #ddd;padding-bottom:3px;font-size:large">Request test(s): <?php echo $view_patient_lab_processed_today['requested_test_names']; ?></div>
                                            ...
                                            <div style="font-weight:bolder;margin:5px; border-bottom:1.5px solid #ddd;padding-bottom:3px;font-size:large">Requested by: <?php echo $source_name ?></div>
                                ...
                                ?></h4>
                                            ...
                                            <tbody>
                                               ...
                                               <tr>
                                                   ...
                                                   <td class="left"><?php echo $get_urine_re['nitrate'] ?></td>
                                                   <!-- <td class="right">-</td>  -->
                                               </tr>
...
<div class="table-responsive-sm">
                                        ...
                                        <div class="header">							
                                <h4><?php echo investigation_name($lab_test)." Test"; 
                                ...
                                ?></h4>
                                            ...
                                            <tbody>
                                               ...
                                               <tr>
                                                    ...
                                                    <td class="left"><?php echo $S_g_GLUTAMYL_TRANSFERASE ?></td>
                                                    <td class="right"> IU/L </td> 
                                                    <td class="right"> <?php echo $S_g_GLUTAMYL_TRANSFERASE_RESULTS ?> </td> 
...
-->
                                              ...
                                              <tr>
                                                    <td class="left strong"><?php echo $P_LCR_NAME ?></td>
                                                    <td class="left"><?php echo $P_LCR ?></td>
                                                    <td class="right"> <?php echo $P_LCR_UNIT ?> </td> 
                                                    <td class="right"> <?php echo $P_LCR_RESULTS ?> </td> 
                                                    <td class="right">  <?php echo $P_LCR_RANGE ?> </td> 
                                               </tr>
...
else if (investigation_name($lab_test) == "TYROID FUNCTION TEST") {
  ?>
                              ...
                              ?></h4>
                                          ...
                                          <tbody>
                                              <tr>
                                                  ...
                                                  <td class=""> HBsAg </td>
                                                  <td class="right"><?php echo $HBsAg ?></td> 
                                              ...
                                              <tr>
                                                 ...
                                                 <td class=""> HBsAb </td>
                                                 <td class="right"><?php echo $HBsAb ?></td> 
                                             ...
                                             <tr>
                                                 ...
                                                 <td class=""> HBeAg </td>
                                                 <td class="right"><?php echo $HBeAg ?></td> 
                                             ...
                                             <tr>
                                                 ...
                                                 <td class=""> HBeAb </td>
                                                 <td class="right"><?php echo $HBeAb ?></td> 
                                             ...
                                             <tr>
                                                 ...
                                                 <td class=""> HBcAb </td>
                                                 <td class="right"><?php echo $HBcAb ?></td> 
                              ...
                              ?></h4>
                                          ...
                                          <tbody>
                                              <tr>
                                                  ...
                                                  <td class="left strong"> OGTT </td>
                                                  <td class="left"><?php echo $get_level_glucose_VAL ?></td>
                                                  <td class="right">mg/dL</td>
                                                  <td class="left"><?php echo $GLUCOSE_RESULTS ?></td>
...
else if (investigation_name($lab_test) == "GONORRHEA") {
  ?>
                              ...
                              ?></h4>
                                          ...
                                          <tbody>
                                              <tr>
                                                  ...
                                                  <td class="left strong"> GONORRHEA </td>
                                                  <td class="left"><?php echo $GONORRHEA_TEST['test_status'] ?></td>
...
else if (investigation_name($lab_test) == "HVSRE") {
  ?>
...
<div class="table-responsive-sm">
                                      ...
                                      <div class="header">							
                              <h4><?php echo "HIGH VIGINAL SWAB(HVS) R/E"; 
                              ...
                              ?></h4>
                                          ...
                                          <tbody>
                                              <tr>
                                                  ...
                                                  <td class="left strong"> E.P Cell </td>
                                                  <td class="left"><?php echo $get_HVSRE_results['ep_cell'] ?></td>
                                              ...
                                              <tr>
                                                 ...
                                                 <td class="left strong"> Pus Cell </td>
                                                 <td class="left"><?php echo $get_HVSRE_results['pus_cell'] ?></td>
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="left strong"> Rbcs </td>
                                                 <td class="left"><?php echo $get_HVSRE_results['rbcs'] ?></td>
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="left strong"> T Vaginalis </td>
                                                 <td class="left"><?php echo $get_HVSRE_results['t_vaginalis'] ?></td>
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="left strong"> Bacteria </td>
                                                 <td class="left"><?php echo $get_HVSRE_results['bacteria'] ?></td>
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="left strong"> Yeast Like Cells </td>
                                                 <td class="left"><?php echo $get_HVSRE_results['yeast_like_cells'] ?></td>
                              ...
                              ?></h4>
                                          ...
                                          <tbody>
                                              <tr>
                                                  ...
                                                  <td class="left strong"> H.PYLORI(SERUM) </td>
