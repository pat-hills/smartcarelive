...
$topic = '<strong > <label style="color: #666">  Consultation Report Generated on ' . strtoupper(date("F j, Y")) . '</label></strong>';
...
$result = search_consulting_patient_reports($staff_id,$start_date,$end_date,$gender);
$i = 0;
while ($row = mysqli_fetch_array($result)) {
 ...
 $patient_phone = $row['phone'];
    ...
    $date_convert = date("F jS, Y", strtotime($row['date_sent'])); 
