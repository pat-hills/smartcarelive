...
require_once "p_parts/heads/landing_head.php";
require_once "p_parts/navbar.php";
require_once "p_parts/sidebar.php";
require_once "tasks/lad_report.php";
require_once "p_parts/foots/landing_foot.php";
...
<html>
   ...
   <body>
       ...
       <table border="1" style="width: 60%" cellpadding="2" cellspacing="1">
         ...
         <tr class="f1" >
             <td colspan="6" style="text-align: center;">TAFO GOVERNMENT HOSPITAL<wbr/> <br> Old Tafo-Kumasi <br /> LABORATORY REPORT</td>
