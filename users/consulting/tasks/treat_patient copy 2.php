...
//calling 
                        ...
                        <div class="content">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><strong>Blood Pressure (mmHg): </strong> <?php echo @$bio_vital['blood_pressure']; ?> </li>
                                <li class="list-group-item"><strong>Temperature (°C): </strong> <?php echo @$bio_vital['temperature']; ?> </li>
                                <li class="list-group-item"><strong>Pulse (Sp02): </strong> <?php echo @$bio_vital['pulse']; ?> </li>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><strong>Blood Pressure (mmHg): </strong> <?php echo @$bio_vital_last_vist['blood_pressure']; ?> </li>
                                <li class="list-group-item"><strong>Temperature (°C): </strong> <?php echo @$bio_vital['temperature']; ?> </li>
                                <li class="list-group-item"><strong>Pulse (Sp02): </strong> <?php echo @$bio_vital['pulse']; ?> </li>
                        ...
                        <div class="md-content" style="border: 1px dashed #3078EF">
                            ...
                            <div class="modal-body form">
                                <form role="form" action="tasks/insert_vitals.php" method="post" autocomplete="off"> 
                                    ...
                                    <div class="form-group">
                                        <label>Height (m)</label> <input  type="text" name="height" value="<?php echo @$_SESSION['height']; ?>" placeholder="" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label>Blood Pressure (mmHg)</label> <input  type="text" name="blood_pressure" value="<?php echo @$_SESSION['blood_pressure']; ?>" placeholder="" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label>Tempature (°C)</label> <input  type="text" name="temperature" value="<?php echo @$_SESSION['temperature']; ?>" placeholder="" class="form-control">
                                    </div>
                    ...
                    <div class="tab-pane <?php echo @$_SESSION['comp_tab']; ?> cont" id="complains">
                        ...
                        <div class="content">
                            <form class="form-horizontal group-border-dashed" method="post" action="db_tasks/add_new_complain.php" style="border-radius: 0px;">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group input-group-lg">
                                                ...
                                                <textarea required name="description" class="form-control" cols="60" rows="60" placeholder="Describe allergy"></textarea>
                                ...
                                <form class="form-horizontal group-border-dashed" action="db_tasks/add_a_next_reviews.php" method="post" style="border-radius: 0px;">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date datetime "  data-min-view="2" data-date-format="yyyy-mm-dd">
                                            <input type="text" name="dov" readonly="" class="form-control" size="16"   >
                    ...
                    <div class="content">
                        <form class="form-horizontal group-border-dashed" method="post" action="db_tasks/add_prescribe.php" style="border-radius: 0px;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                <input style="width:65%;display:inline" autocomplete="off" placeholder="Prescribed Qty" name="drug_qty" required="" class="form-control" type="text">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12" style="float:left;margin-left:20%">
                                        <input style="width:10%;display:inline" autocomplete="off" placeholder="Amount to be taken" name="quantity" required="" class="form-control" type="text">
                                        &nbsp;X&nbsp;
                                        <input style="width:10%;display:inline" autocomplete="off" placeholder="No. of times" name="times" required="" class="form-control" type="text">
                                        ...
                                        <input name="duration" placeholder="Duration" autocomplete="off" required="" class="form-control " style="width:10%;display:inline" type="text">
