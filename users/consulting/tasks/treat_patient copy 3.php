...
//calling 
                        ...
                        <div class="content">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><strong>Blood Pressure (mmHg): </strong> <?php echo @$bio_vital['blood_pressure_top']." / ".$bio_vital['blood_pressure_down'] ?> </li>
                              
                                <li class="list-group-item"><strong>Temperature (°C): </strong> <?php echo @$bio_vital['temperature']; ?> </li>
                                <li class="list-group-item"><strong>Pulse (%): </strong> <?php echo @$bio_vital['pulse']; ?> </li>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><strong>Pulse (%):  </strong> <?php echo @$bio_vital_last_vist['pulse']; ?> </li>
                        ...
                        <div class="md-content" style="border: 1px dashed #3078EF">
                            ...
                            <div class="modal-body form">
                                <form role="form" action="tasks/insert_vitals.php" method="post" autocomplete="off"> 
                                    ...
                                    <div class="form-group">
                                        <label>Pulse </label> <input  type="text" name="pulse" value="<?php echo @$bio_vital['pulse']; ?>" placeholder="" class="form-control">
                                    </div>
                    ...
                    <div class="content">
                        <form class="form-horizontal group-border-dashed" method="post" action="db_tasks/add_prescribe.php" style="border-radius: 0px;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                <input style="width:65%;display:inline" autocomplete="off" placeholder="Prescribed Qty" name="drug_qty" class="form-control" type="text">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12" style="float:left;margin-left:20%">
                                        <input style="width:12%;display:inline" autocomplete="off" placeholder="Amt to be taken" name="quantity" required class="form-control" type="text">
                                        &nbsp;X&nbsp;
                                        ...
                                        <select name="time_interval" required="" class="form-control" style="width:18%;display:inline">
                                        ...
                                        <input name="duration" placeholder="For How Long?" autocomplete="off" required="" class="form-control " style="width:9%;display:inline" type="text">
                                        <select name="time_span" required class="form-control" style="width:23%;display:inline">
