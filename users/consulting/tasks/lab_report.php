...
?>
       ...
       <table border="1" style="width: 60%;" cellpadding="2" cellspacing="1">
         ...
         <tr>
             <td colspan="3"></td>
             <td> </td>
             <td colspan="2">Malaria Parasites: <?php if(isset($_SESSION['malaria_parasites'])) { echo "<strong><span class='label label-success'>". @$_SESSION['malaria_parasites']."</strong></span>";}?></td>
         ...
         <tr>
          ...
          <tr >
             <td colspan="3"> </td>
             <td colspan="3">HBsAg: <?php if(isset($_SESSION['hepavirus'])) { echo "<strong><span class='label label-success'>". @$_SESSION['hepavirus']."</strong></span>";}?></td>
