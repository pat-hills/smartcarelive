...
?>
       ...
       <table border="1" style="width: 60%;" cellpadding="2" cellspacing="1">
         ...
         <tr>
             <td colspan="3" width="">Hb: <?php if(isset($_SESSION['hb'])) { echo "<strong><span class='label label-success'>". @$_SESSION['hb']."</strong></span>";}?> </td>
             <td> 11 - 18 </td>
             <td colspan="2">Sickling:  <?php if(isset($_SESSION['sickling'])) { echo "<strong><span class='label label-success'>". @$_SESSION['sickling']."</strong></span>";}?></td>
             
             
             
         </tr>
         <tr>
             <td colspan="3" width="">PCV: <?php if(isset($_SESSION['pcv'])) { echo "<strong><span class='label label-success'>". @$_SESSION['pcv']."</strong></span>";}?></td>
             <td> 41 - 45</td>
             <td colspan="2">Retics: <?php if(isset($_SESSION['retics'])) { echo "<strong><span class='label label-success'>". @$_SESSION['retics']."</strong></span>";}?></td>
             
             
             
         </tr>
         <tr>
             <td colspan="3" width="">T(WBC) count: <?php if(isset($_SESSION['t_wbc_count'])) { echo "<strong><span class='label label-success'>". @$_SESSION['t_wbc_count']."</strong></span>";}?></td>
             <td> 4 - 10 </td>
             <td colspan="2">Hb Electrophoresis: <?php if(isset($_SESSION['hb_elec'])) { echo "<strong><span class='label label-success'>". @$_SESSION['hb_elec']."</strong></span>";}?></td>
             
             
             
         </tr>
         <tr>
             <td colspan="3" width="">Neutrophils: <?php if(isset($_SESSION['neutrophils'])) { echo "<strong><span class='label label-success'>". @$_SESSION['neutrophils']."</strong></span>";}?></td>
             <td> 40 - 70 </td>
             <td colspan="2"></td>
         ...
         <tr>
             <td colspan="3" width="">Lymphocytes: <?php if(isset($_SESSION['lymphocytes'])) { echo "<strong><span class='label label-success'>". @$_SESSION['lymphocytes']."</strong></span>";}?></td>
             <td> 20 - 50 </td>
             <td colspan="2">ESR : <?php if(isset($_SESSION['esr'])) { echo "<strong><span class='label label-success'>". @$_SESSION['esr']."</strong></span>";}?></td>
             
             
             
         </tr>
         <tr>
             <td colspan="3" width="">Monocytes: <?php if(isset($_SESSION['monocytes'])) { echo "<strong><span class='label label-success'>". @$_SESSION['monocytes']."</strong></span>";}?></td>
             <td> 2 - 10 </td>
             <td colspan="2">G6PD: <?php if(isset($_SESSION['g6pd'])) { echo "<strong><span class='label label-success'>". @$_SESSION['g6pd']."</strong></span>";}?></td>
             
             
             
         </tr>
         <tr>
             <td colspan="3" width="">Eosinophils: <?php if(isset($_SESSION['eosinophils'])) { echo "<strong><span class='label label-success'>". @$_SESSION['eosinophils']."</strong></span>";}?></td>
             <td> 1 - 6 </td>
             <td colspan="2">Blood Group: <?php if(isset($_SESSION['blood_group'])) { echo "<strong><span class='label label-success'>". @$_SESSION['blood_group']."</strong></span>";}?></td>
             
             
             
         </tr>
         <tr>
             <td colspan="3" width="">Basophils: <?php if(isset($_SESSION['basophils'])) { echo "<strong><span class='label label-success'>". @$_SESSION['basophils']."</strong></span>";}?></td>
             <td> 0 - 1 </td>
             <td colspan="2">FBS: <?php if(isset($_SESSION['fbs'])) { echo "<strong><span class='label label-success'>". @$_SESSION['fbs']."</strong></span>";}?></td>
         ...
         <tr>
             <td colspan="3"></td>
             <td> </td>
             <td colspan="2">RBS: <?php if(isset($_SESSION['rbs'])) { echo "<strong><span class='label label-success'>". @$_SESSION['rbs']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             <td colspan="3">pus Cells: <?php if(isset($_SESSION['pus_cells'])) { echo "<strong><span class='label label-success'>". @$_SESSION['pus_cells']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             <td colspan="3">RBC's: <?php if(isset($_SESSION['rbcs'])) { echo "<strong><span class='label label-success'>". @$_SESSION['rbcs']."</strong></span>";}?><strong><?php  echo @$_SESSION['rbcs'];?></td>
         ...
         <tr>
             ...
             <td colspan="3">Epith Cells: <?php if(isset($_SESSION['epith_cells'])) { echo "<strong><span class='label label-success'>". @$_SESSION['epith_cells']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             <td colspan="3">T. Vaginalis: <?php if(isset($_SESSION['t_vaginalis'])) { echo "<strong><span class='label label-success'>". @$_SESSION['t_vaginalis']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             <td colspan="3">Bacteriodes: <?php if(isset($_SESSION['bacteriodes'])) { echo "<strong><span class='label label-success'>". @$_SESSION['bacteriodes']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             <td colspan="3">Yeast Cells: <?php if(isset($_SESSION['yeast_cells'])) { echo "<strong><span class='label label-success'>". @$_SESSION['yeast_cells']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             <td colspan="3">S.H/masoni: <?php if(isset($_SESSION['s_h_masoni'])) { echo "<strong><span class='label label-success'>". @$_SESSION['s_h_masoni']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             <td colspan="3">Crystals: <?php if(isset($_SESSION['crystals'])) { echo "<strong><span class='label label-success'>". @$_SESSION['crystals']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             <td colspan="3">Casts: <?php if(isset($_SESSION['casts'])) { echo "<strong><span class='label label-success'>". @$_SESSION['casts']."</strong></span>";}?></td>
         ...
         <tr>
          ...
          <tr >
             <td colspan="3"> </td>
             <td colspan="3">HBsAg: <?php if(isset($_SESSION['hbsag'])) { echo "<strong><span class='label label-success'>". @$_SESSION['hbsag']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             <td colspan="3">VDRL/KAHN: <?php if(isset($_SESSION['vdrl_kahn'])) { echo "<strong><span class='label label-success'>". @$_SESSION['vdrl_kahn']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             <td colspan="3">URINE PREG TEST: <?php if(isset($_SESSION['urine_preg'])) { echo "<strong><span class='label label-success'>". @$_SESSION['urine_preg']."</strong></span>";}?></td>
         ...
         <tr>
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(2): <?php if(isset($_SESSION['hvs_organism_two'])) { echo "<strong><span class='label label-success'>". @$_SESSION['hvs_organism_two']."</strong></span>";}?><strong></td>
         ...
         <tr>
             <td colspan="3">ORGANISM(S) (1): <?php if(isset($_SESSION['gs_org_1'])) { echo "<strong><span class='label label-success'>". @$_SESSION['gs_org_1']."</strong></span>";}?></td>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(2): <?php if(isset($_SESSION['gs_org_2'])) { echo "<strong><span class='label label-success'>". @$_SESSION['gs_org_2']."</strong></span>";}?></td>
