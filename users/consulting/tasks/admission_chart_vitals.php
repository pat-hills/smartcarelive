    ...
    <div class="row">
      ...
      <div class="block-flat profile-info">
          <div class="row">
            ...
            <select id="vitalsAdmission" name="vitals" required="" class="form-control">
        ...
        <div class="row TemperatureAdmission">
				  <div class="col-md-12">
               ...
               <div id="chart-container" >
                 <canvas id="graphCanvasTemperatureAdmission" ></canvas>
               </div>
       ...
       <div class="row WeightAdmission">
              ...
              <?php echo @$_SESSION['surname']?>'s Weight ( Kg ) Charts
               ...
               <div id="chart-container" >
                 <canvas id="graphCanvasWeightAdmission" ></canvas>
               </div>
        ...
        <div class="row PulseAdmission">
          <div class="col-md-12">
              ...
              <?php echo @$_SESSION['surname']?>'s Pulse ( % ) Charts
               ...
               <div id="chart-container" >
                 <canvas id="graphCanvasPulseAdmission" ></canvas>
               </div>
